...
train_dataset = dict(
    ...
    datasets=[
        ...
        classes=classes,
        env_id=0,
        ann_file="/benchmark/持续学习数据集/public_data/kitti_COCO_format/annotations/only_car_instances_train2014.json",
...
resume_from = None
interval = 10
load_from = "/home/ml/code/mmdetection/work_dirs/yolox_fs_x_640x640_50e_kitti_base/best_bbox_mAP_epoch_70.pth"
