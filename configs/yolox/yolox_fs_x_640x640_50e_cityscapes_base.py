...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='/nfs/public_data/cityscapes_COCO_format/annotations/instances_train2014.json',
        img_prefix='/nfs/public_data/cityscapes_COCO_format/train2014/',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file='/nfs/public_data/cityscapes_COCO_format/annotations/instances_val2014.json',
        img_prefix='/nfs/public_data/cityscapes_COCO_format/val2014/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file='/nfs/public_data/foggy_cityscapes_COCO_format/annotations/instances_val2014.json',
        img_prefix='/nfs/public_data/foggy_cityscapes_COCO_format/val2014/',
        pipeline=test_pipeline))
