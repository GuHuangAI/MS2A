...
train_dataset = dict(
    ...
    datasets=[
        ...
        classes=classes,
        env_id=0,
        ann_file="/benchmark/持续学习数据集/public_data/SIM10k_COCO_format/annotations/only_car_instances_train2014_64_2.json",
        ...
        classes=classes,
        env_id=1,
        ann_file="/benchmark/持续学习数据集/public_data/cityscapes_COCO_format/annotations/only_car_instances_train2014_8_2.json",
...
optimizer = dict(
    ...
    nesterov=True,
    paramwise_cfg=dict(
        custom_keys={'backbone': dict(lr_mult=1.), 'neck': dict(lr_mult=1.), 'norm': dict(decay_mult=0.), 'bias': dict(decay_mult=0.),
        'clus_m': dict(lr_mult=0.4)
        })
    )
...
resume_from = None
interval = 10
load_from = "/home/ml/code/mmdetection/work_dirs/yolox_fs_x_640x640_50e_sim10k_pretrain_mom/best_0_bbox_mAP_epoch_50.pth"
