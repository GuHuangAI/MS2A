...
model = dict(
    ...
    bbox_head=dict(
        ...
        in_channel2=100,
        cluster=dict(cityscapes='/nfs/projects/few_shot/fewshot_fea/Indus_S_T1/Indus_S_cluster.pth',
        foggy_cityscapes='/nfs/projects/few_shot/fewshot_fea/Indus_S_T1/Indus_T1_cluster.pth',),
...
train_dataset = dict(
    ...
    datasets=[
        ...
        classes=classes,
        env_id=1,
        ann_file="/nfs/testset/Indus_T1_COCO_format/annotations/instances_train2017.json",
        img_prefix="/nfs/testset/Indus_T1_COCO_format/train2017/",
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True)
        ],
...
val_22 = dict(
    classes=classes,
    type=dataset_type,
    ann_file="/nfs/testset/Indus_T1_COCO_format/annotations/instances_val2017.json",
    img_prefix='/nfs/testset/Indus_T1_COCO_format/val2017/',
    env_id=1,
    pipeline=test_pipeline)
