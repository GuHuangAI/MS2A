...
model = dict(
    ...
    bbox_head=dict(
        ...
        in_channel2=100,
        cluster=dict(cityscapes='/benchmark/持续学习数据集/projects/few_shot/fewshot_fea/Indus_T2/Indus_S_cluster.pth',
        foggy_cityscapes='/benchmark/持续学习数据集/projects/few_shot/fewshot_fea/Indus_T2/Indus_T2_cluster.pth',),
...
train_dataset = dict(
    ...
    datasets=[
        ...
        classes=classes,
        env_id=1,
        ann_file="/nfs/testset/Indus_T2_COCO_format/annotations/instances_train2017_10.json",
        img_prefix="/nfs/testset/Indus_T2_COCO_format/train2017/",
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True)
        ],
...
val_22 = dict(
    classes=classes,
    type=dataset_type,
    ann_file="/benchmark/持续学习数据集/testset/Indus_T2_COCO_format/annotations/instances_val2017.json",
    img_prefix='/benchmark/持续学习数据集/testset/Indus_T2_COCO_format/val2017/',
    env_id=1,
    pipeline=test_pipeline)
...
resume_from = None
interval = 10
load_from = "/home/ml/code/mmdetection/work_dirs/yolox_fs_x_640x640_50e_Indus_S_base/best_bbox_mAP_epoch_69.pth"
