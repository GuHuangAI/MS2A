...
train_dataset = dict(
    ...
    dataset=dict(
        classes=classes,
        type=dataset_type,
        ann_file='/nfs/public_data/SIM10k_COCO_format/annotations/only_car_instances_train2014.json',
        img_prefix='/nfs/public_data/SIM10k_COCO_format/train2014/',
        pipeline=[
...
data = dict(
    ...
    val=dict(
        classes=classes,
        type=dataset_type,
        ann_file='/nfs/public_data/SIM10k_COCO_format/annotations/only_car_instances_val2014.json',
        img_prefix='/nfs/public_data/SIM10k_COCO_format/train2014/',
        pipeline=test_pipeline),
    test=dict(
        classes=classes,
        type=dataset_type,
        ann_file='/nfs/public_data/cityscapes_COCO_format/annotations/only_car_instances_train2014_500_2.json',
